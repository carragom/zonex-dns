...
import type { ParsedRecord } from './utils/records.parser.ts'
			...
			expected: [
				{
					...
					type: 'SOA',
					rdata:
						'ns1.example.com. hostmaster.example.com. 2025091801 7200 3600 1209600 3600',
			...
			expected: [
				{
					...
					type: 'TXT',
					rdata:
						'v=DKIM1; k=rsa; p=MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQC 9uYTGNiBNtZCnIiCiMGniCvQxhw3zskMgTX7sjHWyujRdoXZiAyZw8XDhXLwucNyfrcMhtV2fx701w1roT18JD1lBEZTgG3ZUZS4gnQu1LrRf0l4m618r6ZRO5UJKR1NU5eLr+ZOzi+XEcok4H2MazQn1zjZHwFntoBmy1JzEEQIDAQAB',
					text:
						'v=DKIM1; k=rsa; p=MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQC 9uYTGNiBNtZCnIiCiMGniCvQxhw3zskMgTX7sjHWyujRdoXZiAyZw8XDhXLwucNyfrcMhtV2fx701w1roT18JD1lBEZTgG3ZUZS4gnQu1LrRf0l4m618r6ZRO5UJKR1NU5eLr+ZOzi+XEcok4H2MazQn1zjZHwFntoBmy1JzEEQIDAQAB',
				},
			],
